...
- A simple python CALCULATOR program without GUI

# Asking for which operation to do

- At first, we print "Which operation do you want to perform: "
```
print("Which operation do you want to perform:")
```

An empty `print()` tag makes an empty line


- Now, lets give options of which operation to be performed:-
```
print("1. Addition")
print("2. Subtraction")
...
- Taking user ```input()``` and storing it in the variable `operation`
...
If the variable `operation` is inputed as 1, 
